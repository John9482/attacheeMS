            ...
            <div class="card-body">
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        <a href="fsrp.php" 
                           class="btn btn-outline-success financial-year-btn <?php echo empty($financial_year_filter) ? 'active' : ''; ?>"
                           data-year="">
                            All Years
                        </a>
                        ...
                        ?>
                            <a href="fsrp.php?financial_year=<?php echo urlencode($year); ?>" 
                               class="btn btn-outline-success financial-year-btn <?php echo $financial_year_filter === $year ? 'active' : ''; ?>"
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Food Safety and Research Program Department'); ?></p>
                </div>
                <div class="department-actions">
                    <a href="../add_attachee.php?department=<?php echo $department['id']; ?>" class="btn btn-success">
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="fsrp.php" class="btn btn-outline-secondary">
    ...
    <div id="all-years">
            ...
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" class="d-flex">
                                                ...
                                                <noscript>
                                                    <button type="submit" name="update_location" class="btn btn-sm btn-success ms-2">Update</button>
                                                </noscript>
                                            </form>
                                        </td>
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the FSRP department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the FSRP department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="row mb-4">
                    ...
                    ?>
                        <div class="col-md-3 mb-3">
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-success' : ''; ?>">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="fsrp.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-success">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
