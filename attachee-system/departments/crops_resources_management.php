...
// Get department info
$department_name = 'Crops Resources Management';
...
if(isset($_POST['update_location'])) {
    ...
    header("Location: crops_resources_management.php");
    exit();
}
            ...
            <div class="card-body">
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        <a href="crops_resources_management.php" 
                        ...
                        ?>
                            <a href="crops_resources_management.php?financial_year=<?php echo urlencode($year); ?>" 
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Crops Resources Management Department'); ?></p>
                </div>
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="crops_resources_management.php" class="btn btn-outline-secondary">
    ...
    <div id="all-years">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the Crops Resources Management department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the Crops Resources Management department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-primary' : ''; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="crops_resources_management.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-primary">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
