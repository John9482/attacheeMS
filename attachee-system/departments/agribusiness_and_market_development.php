...
// Get department info
$department_name = 'Agribusiness and Market Development';
...
if(isset($_POST['update_location'])) {
    ...
    header("Location: agribusiness_and_market_development.php");
    exit();
}
            ...
            <div class="card-body">
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        <a href="agribusiness_and_market_development.php" 
                        ...
                        ?>
                            <a href="agribusiness_and_market_development.php?financial_year=<?php echo urlencode($year); ?>" 
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Agribusiness and Market Development Department'); ?></p>
                </div>
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="agribusiness_and_market_development.php" class="btn btn-outline-secondary">
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <div class="btn-group">
                            <a href="../reports/export.php?department=<?php echo $department['id']; ?>&type=active&search=<?php echo urlencode($search); ?>&school=<?php echo urlencode($school_filter); ?>&financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo urlencode($quarter_filter); ?>&date_from=<?php echo urlencode($date_from); ?>&date_to=<?php echo urlencode($date_to); ?>" 
                               class="btn btn-light btn-sm">
                                <i class="bi bi-download"></i> Export Active
                            </a>
                            <a href="../reports/export.php?department=<?php echo $department['id']; ?>&type=all&search=<?php echo urlencode($search); ?>&school=<?php echo urlencode($school_filter); ?>&financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo urlencode($quarter_filter); ?>&date_from=<?php echo urlencode($date_from); ?>&date_to=<?php echo urlencode($date_to); ?>" 
                               class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the Agribusiness and Market Development department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <div class="btn-group">
                            <a href="../reports/export.php?department=<?php echo $department['id']; ?>&type=completed&search=<?php echo urlencode($search); ?>&school=<?php echo urlencode($school_filter); ?>&financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo urlencode($quarter_filter); ?>&date_from=<?php echo urlencode($date_from); ?>&date_to=<?php echo urlencode($date_to); ?>" 
                               class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the Agribusiness and Market Development department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-primary' : ''; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="agribusiness_and_market_development.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-primary">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
