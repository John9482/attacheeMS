                ...
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        <a href="engineering.php" 
                           class="btn btn-outline-danger financial-year-btn <?php echo empty($financial_year_filter) ? 'active' : ''; ?>"
                           data-year="">
                            All Years
                        </a>
                        ...
                        ?>
                            <a href="engineering.php?financial_year=<?php echo urlencode($year); ?>" 
                               class="btn btn-outline-danger financial-year-btn <?php echo $financial_year_filter === $year ? 'active' : ''; ?>"
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Engineering Department'); ?></p>
                </div>
                <div class="department-actions">
                    <a href="../add_attachee.php?department=<?php echo $department['id']; ?>" class="btn btn-danger">
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="engineering.php" class="btn btn-outline-secondary">
    ...
    <div id="all-years">
            ...
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" class="d-flex">
                                                ...
                                                <noscript>
                                                    <button type="submit" name="update_location" class="btn btn-sm btn-danger ms-2">Update</button>
                                                </noscript>
                                            </form>
                                        </td>
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the Engineering department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the Engineering department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="row mb-4">
                    ...
                    ?>
                        <div class="col-md-3 mb-3">
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-danger' : ''; ?>">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="engineering.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-danger">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
