...
// Get department info
$department_name = 'Policy Registry';
...
if(isset($_POST['update_location'])) {
    ...
    header("Location: policy_registry.php");
    exit();
}
            ...
            <div class="card-body">
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        ...
                        ?>
                            <a href="policy_registry.php?financial_year=<?php echo urlencode($year); ?>" 
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Policy documentation, registration, and archival services'); ?></p>
                </div>
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="policy_registry.php" class="btn btn-outline-secondary">
    ...
    <div id="all-years">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the Policy Registry department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the Policy Registry department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-primary' : ''; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="policy_registry.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-primary">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
