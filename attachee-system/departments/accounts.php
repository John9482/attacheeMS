            ...
            <div class="card-body">
                <div class="financial-year-slider">
                    <div class="btn-group" role="group">
                        ...
                        ?>
                            <a href="accounts.php?financial_year=<?php echo urlencode($year); ?>" 
        ...
        <div class="department-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($department['description'] ?? 'Accounts and Finance Department'); ?></p>
                </div>
    ...
    <div id="all-years">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No active attachees found in the Accounts department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        No completed attachees found in the Accounts department.
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <div class="card h-100 <?php echo $quarter_filter === $q ? 'border-primary' : ''; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="accounts.php?financial_year=<?php echo urlencode($financial_year_filter); ?>&quarter=<?php echo $q; ?>" class="btn btn-sm btn-outline-primary">
                                            View Quarter
                                        </a>
                                    </div>
                                </div>
